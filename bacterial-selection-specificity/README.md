...
Note that panels 2F and 2G were reordered after the initial batch of sequence reads were uploaded to the SRA. To reproduce the DNA specificity motif for the FAGGG loop in Extended Data Figure 2F, you will need the following data files:
