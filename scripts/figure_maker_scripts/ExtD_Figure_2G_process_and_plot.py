...
if __name__ == "__main__":
    ...
    hairpin_seq = input_filename_list[0][
                  15:27]  # the amino acid sequence of the loop variant is found within the filename
    ...
    for hexamer in HEXAMERS:
        if len(fraction_list_dict[hexamer]) == len(
                input_filename_list):  # only analyzes sequences that occur in all replicates
